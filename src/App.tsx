  ...
  <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-slate-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-16">
        ...
        >
          <img src="/toasterailogo.png" alt="ToasterAI" className="h-14 object-contain mix-blend-multiply" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center gap-2 mb-6 cursor-pointer" onClick={() => onNavigate('landing')}>
            <img src="/toasterailogo.png" alt="ToasterAI" className="h-16 object-contain brightness-0 invert" />
